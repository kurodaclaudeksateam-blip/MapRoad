...
3. **Asignación de tiendas por chofer** — tabla de puntos de entrega con asignación por dropdown, filtrable por centro. Latitud/longitud son **obligatorias** al crear/editar una tienda — sin coordenadas no se puede ubicar en la ruta óptima ni en el mapa.
4. **Centros / razón social** — administra depósitos (lat/lng **obligatorias**: es el punto de partida real desde el que se calcula la ruta óptima de cada chofer) y su razón social.
